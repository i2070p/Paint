...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // show_homepage
        if ($pathinfo === '/show') {
            return array (  '_controller' => 'MainBundle\\Controller\\DefaultController::showAction',  '_route' => 'show_homepage',);
        }

        if (0 === strpos($pathinfo, '/register')) {
            // account_register
            if ($pathinfo === '/register') {
                return array (  '_controller' => 'MainBundle\\Controller\\AccountController::registerAction',  '_route' => 'account_register',);
            }

            // account_create
            if ($pathinfo === '/register/create') {
                return array (  '_controller' => 'MainBundle\\Controller\\AccountController::createAction',  '_route' => 'account_create',);
            }
